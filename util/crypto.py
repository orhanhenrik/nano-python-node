...
async def verify_signature_async(hash: bytes, signature: bytes, public_key: bytes):
    _loop = asyncio.get_event_loop()
    return await _loop.run_in_executor(thread_executor, verify_signature, hash, signature, public_key)
